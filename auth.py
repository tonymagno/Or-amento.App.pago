...
def tela_login() -> None:
    ...
    st.markdown(
        ...
        <style>
            ...
            .card-title { text-align:center; color:white; font-size:1.8rem; font-weight:900; margin:2px 0 2px 0; }
            .card-sub { text-align:center; color:#94a3b8; margin-bottom: 12px; line-height: 1.7; }
